...
func TestToCamelCase(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := strcase.ToCamelCase(tt.s); got != tt.want {
...
func TestToLowerCamelCase(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := strcase.ToLowerCamelCase(tt.s); got != tt.want {
...
func TestToSnakeCase(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.name == "HasNumber" {
				t.Skip("TODO(zchee): support number")
			}
			if got := strcase.ToSnakeCase(tt.s); got != tt.want {
...
func TestToScreamingSnakeCase(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := strcase.ToScreamingSnakeCase(tt.s); got != tt.want {
...
func TestToKebab(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := strcase.ToKebab(tt.s); got != tt.want {
...
func TestToScreamingKebab(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := strcase.ToScreamingKebab(tt.s); got != tt.want {
...
func TestToDelimited(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := strcase.ToDelimited(tt.args.s, tt.args.del); got != tt.want {
...
func TestToScreamingDelimited(t *testing.T) {
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := strcase.ToScreamingDelimited(tt.args.s, tt.args.del, tt.args.screaming); got != tt.want {
